...
function getById(id, callback) {
	pool.getConnection((err, con) => {
		...
		con.query("SELECT customer_id, email, name, password, role FROM customer WHERE customer_id = ? UNION ALL SELECT employee_id, email, name, password, role FROM employee WHERE employee_id = ?", [id, id], function (err, users, fields) {
			con.release();
